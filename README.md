...
I believed this is due to the sma capacitos. However I noted that this issue when away if I lowered the voltage the mininum voltage of 1.2V and then raised to the wanted voltage. So it seems that the step-down switch and regulator had issues if the initial load was too much. 
