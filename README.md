...
I also noted that the 2 stage feedback needed a simple fixed. When I tried the circuit for the first time it got stuck at Vin=2.6V and Vout=1.8V and could not output any other voltage. This was fixed by making the Vi-Vout > 3Volts since the LM317 requires that minimun voltage. Also, It was noted that LM317 needs that >3Volt difference to work and if 1 amp is going through it will burn 3 Watts. 
